...
not alternate identities.  Artifact-path uniqueness is evaluated only after
that grammar is enforced; a payload and any compliance artifact can never name
one staged file through different spellings.
