...
PLEBIAN_OS_INSTALL_WAYDROID="${PLEBIAN_OS_INSTALL_WAYDROID:-0}"
PLEBIAN_OS_WAYDROID_CLOSURE_SHA256="${PLEBIAN_OS_WAYDROID_CLOSURE_SHA256:-}"
...
stage_final_provenance() {
...

    {
        ...
        provenance_kv PLEBIAN_OS_INSTALL_WAYDROID "$PLEBIAN_OS_INSTALL_WAYDROID"
        provenance_kv PLEBIAN_OS_WAYDROID_CLOSURE_SHA256 "$PLEBIAN_OS_WAYDROID_CLOSURE_SHA256"
        ...
        provenance_kv PLEBIAN_OS_UV_INSTALLER_MAX_BYTES "$PLEBIAN_OS_UV_INSTALLER_MAX_BYTES"
