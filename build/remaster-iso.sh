...
write_build_info() {
    ...
    gpl2_license_sha="$(sha256sum "$GPL2_LICENSE" | awk '{print $1}')"
    {
        ...
        manifest_kv PLEBIAN_OS_DESKTOP "${PLEBIAN_OS_DESKTOP:-0}"
        ...
        manifest_kv PLEBIAN_OS_INSTALL_VOICE_MODEL "${PLEBIAN_OS_INSTALL_VOICE_MODEL:-1}"
...
write_firstboot_env() {
    ...
    fi
    {
        ...
        env_kv PLEBIAN_OS_DESKTOP "${PLEBIAN_OS_DESKTOP:-0}"
        ...
        env_kv PLEBIAN_OS_INSTALL_VOICE_MODEL "${PLEBIAN_OS_INSTALL_VOICE_MODEL:-1}"
